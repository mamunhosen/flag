...
(function(factory) {
    ...
    var pluginName = "intlTelInput", id = 1,topCountry=getDynamicCountry(), // give each instance it's own id for namespaced event handling
    defaults = {
        ...
        preferredCountries: [topCountry,'us'],
